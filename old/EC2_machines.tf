resource "aws_instance" "phpapp" {
  ...
  echo "\$conn = new mysqli('mydatabase.dexterlab.internal', 'root', 'secret', 'test');" >> /var/www/html/calldb.php
...
resource "aws_instance" "database" {
  ...
  mysql -u root -psecret -e "INSERT INTO mytable (mycol) values ('dexterlab is working') ;" test
HEREDOC
}
